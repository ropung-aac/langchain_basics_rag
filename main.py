...
medical_knowledge = [
    """
    라면과 혈당 관리: 라면은 정제된 밀가루로 만든 면과 나트륨이 많은 스프로 구성되어 있어 혈당을 급격히 올립니다. 
    GI지수가 높아 당뇨병 환자에게는 특히 주의가 필요한 음식입니다. 
    라면 대신 현미면이나 메밀면, 곤약면을 추천합니다. 야채를 많이 넣어 식이섬유를 보충하면 혈당 상승을 완화할 수 있어요.
    """,
    """
    튀김류와 대사질환: 치킨, 돈가스, 감자튀김 등 튀김류는 트랜스지방과 포화지방이 많아 인슐린 저항성을 증가시킵니다.
    체중 증가와 염증 반응을 유발할 수 있어 대사질환 환자에게는 피해야 할 음식입니다.
    대안으로는 에어프라이어를 이용한 구이나 찜 요리를 추천합니다. 닭가슴살 구이나 생선구이가 좋은 선택이에요.
    """,
    """
    정제 탄수화물의 위험성: 흰쌀, 흰빵, 떡, 과자 등 정제된 탄수화물은 혈당을 빠르게 올립니다.
    현미, 귀리, 통밀빵, 퀴노아 등 복합탄수화물로 대체하는 것이 좋습니다.
    식이섬유가 풍부한 채소와 함께 섭취하면 혈당 상승을 완화할 수 있습니다.
    """,
    """
    단 음식과 인슐린: 케이크, 과자, 아이스크림, 탄산음료 등 설탕이 많은 음식은 인슐린 분비를 과도하게 자극합니다.
    장기적으로 인슐린 저항성과 제2형 당뇨병 발병 위험을 높입니다.
    과일이나 견과류, 다크초콜릿으로 단맛을 대신하는 것을 추천합니다.
    """,
    """
    나트륨과 혈압 관리: 짠 음식은 혈압을 올리고 부종을 유발할 수 있습니다.
    가공식품, 인스턴트 식품, 젓갈류에는 숨어있는 나트륨이 많습니다.
    신선한 재료로 집에서 조리하고, 허브나 향신료로 맛을 내는 것이 좋습니다.
    """,
    """
    식이섬유의 중요성: 채소, 과일, 통곡물에 포함된 식이섬유는 혈당 상승을 완화하고 
    포만감을 오래 유지시켜줍니다. 또한 장내 미생물 균형에도 도움이 됩니다.
    하루에 25-30g의 식이섬유 섭취를 권장합니다. 브로콜리, 시금치, 사과, 배 등이 좋은 공급원이에요.
    """,
    """
    단백질과 근육량 유지: 살코기, 생선, 두부, 콩류 등의 단백질은 혈당을 안정시키고
    근육량 유지에 도움이 됩니다. 체중 관리에도 효과적입니다.
    체중 1kg당 0.8-1.2g의 단백질 섭취를 권장합니다. 닭가슴살, 연어, 두부, 렌틸콩이 좋은 선택이에요.
    """,
    """
    건강한 지방 섭취: 올리브오일, 견과류, 아보카도, 등푸른생선의 오메가-3 지방산은
    염증을 줄이고 심혈관 건강에 도움이 됩니다.
    트랜스지방과 과도한 포화지방은 피하는 것이 좋습니다. 견과류 한 줌, 올리브오일 한 스푼 정도가 적당해요.
    """,
    """
    패스트푸드의 문제점: 햄버거, 피자, 핫도그 등 패스트푸드는 칼로리, 나트륨, 트랜스지방이 높습니다.
    혈당 급상승과 체중 증가를 유발하며, 만성질환 위험을 높입니다.
    집에서 만든 샐러드나 그릴 요리로 대체하는 것을 추천합니다.
    """,
    """
    음료와 건강: 탄산음료, 주스, 커피음료에는 많은 설탕이 들어있습니다.
    물, 무설탕 차, 탄산수가 가장 좋은 선택입니다.
    커피는 하루 2-3잔 이내로 제한하고, 설탕 대신 계피나 바닐라 에센스로 맛을 내보세요.
    """
]
                ...
                try:
                    ...
                    recognition_message = HumanMessage(
                        content=[
                            {
                                "type": "text",
                                "text": "이 이미지에 있는 음식의 이름을 정확하게 알려주세요. 한국어로 답변해주세요. 음식명만 간단히 답변해주세요."
                            },
                            {
                                "type": "image_url",
                                "image_url": {
                    ...
                    **중요**: 반드시 우창윤 선생님의 친근한 말투로만 답변하세요!
                    ...
                    이 음식은 [RAG 지식 기반 영양학적 분석]라서 [건강에 미치는 영향]답니다~ 
                    [구체적 이유]때문에 [주의사항]해요. 
